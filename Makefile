...
SRCS_FILES	=	main.c init.c error.c mapValidation.c debug.c colorValidation.c textureValidation.c configValidation.c \
				fileParsing.c render2dMap.c movement.c drawing.c textures.c ui.c directions.c helper.c pixels.c \
				raycast.c
